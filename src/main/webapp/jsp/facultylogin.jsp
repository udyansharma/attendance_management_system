...
<div class="panel panel-yellow ">
  ...
  <li role="presentation" class="active" style="color:black;font-weight:bold;">Faculty Login</li>
</ul>
</h3>
  </div>
  <div class="panel-body">
  <form:form id="faclgForm" modelAttribute="faculty_login" action="faculty_process" method="post" onsubmit="return faclgn()">      
  <div class="form-group">
       <form:label path="id">Faculty Id: </form:label>
  <form:input required="required" path="id" class="form-control" id="fid" />
  <div id="fidm" style="color: red;"></div>
  </div>
  <div class="form-group">
  	<form:label path="password">Password:</form:label>
    <form:input required="required" type="password" path="password" class="form-control" id="password" />
  <div id="fpwm" style="color: red;"></div>
  </div>
