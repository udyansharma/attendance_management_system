  ...
  <div class="panel-heading ">
      <h3 class="panel-title ">  
		...
		<div class="panel-body"> 
		 <form id="regForm" action="deletestd" method="post">
						...
						<div class="form-group">
                            ...
                            <input name="batch" id="batch" class="form-control" />
                        </div>
				     <button id="register" name="register" class="btn btn-default">Delete</button>
            </form> 
 </div>
  </div>		
    </body>
