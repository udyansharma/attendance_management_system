...
<div class="panel col-sm-4" align="center" style="margin-left:250px;margin-top:-20px;">
  <div class="panel-heading ">
      <h3 class="panel-title ">Edit Faculty  
</h3>
  </div>
		<div class="panel-body"> 
            <form:form id="editFacForm" action="updatefac" method="post" onsubmit="editFac()">
            			<div class="form-group">
						    <label for="id">ID</label>
                            <input name="id" id="id" class="form-control" value="${olduser.id}"  disabled="true" />
                             <input
				...
				<div class="form-group">
				      <label for="name">Name</label>
                            <input name="name" id="name" class="form-control" value="${olduser.name}" required="true"/>
                <div id="namem" style="color: red;"></div>
                </div>   
				<div class="form-group">
								<label for="email">Email</label>
                            <input name="email" id="email" class="form-control" value="${olduser.email}"required="true" />
                </div>   
				<div class="form-group">
				<label for="dept">Department</label>
                    	<select name="dept" id="dept" class="form-control" required="true">
	                        <option value="${olduser.dept}" selected>${olduser.dept}</option>
				...
				<div class="form-group">
				    <label for="address">Address</label>
                            <input name="address" id="address" class="form-control" value="${olduser.address}" required="true" />
                </div>   
				<div class="form-group">
                            <label for="contact">Phone</label>
                            <input  name="contact" id="contact" class="form-control" value="${olduser.contact}" required="true" />
				<div id="contactm" style="color: red;"></div>
				</div>   
			  
				     <button type="submit" id="register" name="register" class="btn btn-default">Add</button>
            </form:form> 
 </div>
  </div>		
    </body>
