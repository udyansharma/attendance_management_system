...
<body>
	...
	<div class="panel col-sm-4" align="center"
		...
		<div class="panel-body">
			...
			<form:form id="addStdForm" modelAttribute="add_student"
				action="registerstudentProcess" method="post" onsubmit="addStd()">
				...
				<div class="form-group">
					...
					<form:select path="batch" name="batch" id="batch"
						class="form-control" required="true">
						<option value="" style="align:center;" selected>Choose Batch</option>
				...
				<div class="form-group">
					...
					<form:input path="session" name="session" id="session"
						class="form-control" required="true"/>
						<div id="sessionm" style="color: red;"></div>
				</div>
				<div class="form-group">
