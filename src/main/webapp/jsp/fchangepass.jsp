    	...
    	<div class="col-sm-2">
	    	<nav class="nav-sidebar">
				<ul class="nav tabs">
		          ...
		          <li class="active" ><a href="update_atten">Update Attendance</a></li>  
...
<form:form id="changefacForm" modelAttribute="fchange" action="fchanged" method="post" onsubmit="return faccp()">
            			<div class="form-group">
                        <form:input type="hidden" path="id" value="${facultysession.id}"/> 
                            <form:label path="password">Password: </form:label>
					<form:input required="true" type="password" class="form-control" id="pass" path="password" />
