...
<div class="panel panel-yellow ">
  ...
  <li role="presentation" class="active" style="color:black;font-weight:bold;">Student Login</li>
</ul>
</h3>
  </div>
  <div class="panel-body">
  <form:form id="stdlgForm" modelAttribute="student_login" action="student_process" method="post" onsubmit="return stdlgn()">    
  <div class="form-group">
          <form:label path="id">Enrollment Number: </form:label>
          <form:input required="required" class="form-control" path="id" id="sid" />
  <div id="sidm" style="color: red;"></div>
  </div>
  <div class="form-group">
