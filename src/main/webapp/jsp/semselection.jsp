  ...
  <div class="panel-heading ">
      <h3 class="panel-title ">  
		...
		<div class="panel-body"> 
		    <form:form id="regForm" action="chose_sub" method="post">
						...
						<div class="form-group">
						<label>Branch</label>
                    <input type="hidden" name="dept" value="${facultysession.getDept()}">
                   <select  name="branch" id="branch" class="form-control" required="true">
